...
def CRFs(original_image_path,predicted_image_path,CRF_image_path):
    ...
    # os.makedirs(CRF_image_path, exist_ok=True)
...
if __name__ == "__main__":
    img_path = "../data/Potsdam512/img"
    mask_path = "../data/FastFCN_50_512_878/color"
    output_path = "../data/Output/DenseCRF/FastFCN_50_512"
    for im_name in tqdm.tqdm(os.listdir(img_path)):
        CRFs(os.path.join(img_path, im_name), os.path.join(mask_path, im_name[:-6]+"color.png"), os.path.join(output_path, im_name[:-7]+".png"))
